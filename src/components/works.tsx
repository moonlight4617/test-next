...
export const Works = () => {
  return (
    <div className="md:mt-64 md:mx-[10%] mt-24 animate-fade-in-left" id="portfolio">
      ...
      <Link href="/portfolio" className="group">
        ...
        <div className="mt-12 group w-[12rem] ml-auto text-right">
          <p className="group text-lg ">ポートフォリオ一覧</p>
