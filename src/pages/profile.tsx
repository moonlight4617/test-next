    ...
    <div className="bg-[#f2f2e9] w-full h-full">
      ...
      <div className="container w-2/3 mx-auto pt-24">
        ...
        <div className="flex mt-40">
          ...
          <div className="ml-28">
            <span className="text-2xl font-sans mb-2 border border-black bg-white py-2 px-12">
              経歴
            </span>
            <p className="p-12 text-sm">
              神奈川県厚木市出身。
              <br />
              個人経営イナズマカフェで勤務後、「俺の株式会社」フレンチ、ベーカリー部門で勤務。
              <br />
            ...
            <div className="p-12 text-sm">
              <a href="https://fluid-27.hatenablog.com/">
                https://fluid-27.hatenablog.com/
              </a>
            </div>
          </div>
        </div>
